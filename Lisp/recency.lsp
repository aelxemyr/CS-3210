...
;; ===========================================================================
;; Sort by recency: given a word and a list of words, rearranges the list 
;; based on recency. If the word is not in the list, the word is added at the
;; front of the list. If the word is in the list, its position is changed to 
